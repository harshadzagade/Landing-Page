    ...
    <main>
        <section class="secton-thankyou">
            <div class=" thankyou-content text-center">
                ...
                <h3 class="thankyou-title">Greetings from MET</h3>

                <p class="thankyou-subtitle">
                    Thank you for your Interest.
                    Our Counsellor will get in touch with you shortly.
                </p>
                <p class="thankyou-subtitle">Your download will start automatically. If it doesn't, <a href="assets/pdf/PGDM-HANDOUT.pdf" download>click here</a>.</p>
                <a id="download-pdf" class="download-pdf d-none" href="./assets/pdf/PGDM-HANDOUT.pdf" download>Download PDF</a>
            </div>
        </section>
    </main>
