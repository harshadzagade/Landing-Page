                    ...
                    <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6 col-12 pt-5">
                        <div class="banner-txt">
                            <div class="visualtxt ">
                                ...
                                <p>
                                    <span class="linetext b-clr">PGPMBA - Insurance</span><br>
                                </p>
                                <p>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-12 col-sm-12 col-12" style="z-index:1;">
                        <div class="banform" id="banform">
                            <div class="form-content">
                                ...
                                <div class="form-body">
                                    <!-- <p>Get In Touch </p> -->
                                    <form id="pop-form" action="MBA-in-Insurance-Visit10.php" method="POST" novalidate
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <input type="hidden" name="page_name" value="EMBA Insurance10">
