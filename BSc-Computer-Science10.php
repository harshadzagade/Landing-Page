                        ...
                        <div class="banner-txt">
                            <div class="visualtxt ">
                                ...
                                <p>
                                    ...
                                    2 + 1 with an option for 3rd year Transfer to Goldsmiths, University of London,
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-12 col-sm-12 col-12" style="z-index:1;">
                        <div class="banform" id="banform">
                            <div class="form-content">
                                ...
                                <div class="form-body">
                                    <!-- <p>Get In Touch </p> -->
                                    <form id="pop-form" action="BSc-Computer-Science-Visit10.php" method="POST" novalidate
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <input type="hidden" name="page_name" value="IIS UOL GS10">
