...
<head>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-T7VVW3NP');
    </script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T7VVW3NP"
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-12 col-sm-12 col-12" style="z-index:1;">
                        <div class="banform" id="banform">
                            <div class="form-content">
                                ...
                                <div class="form-body">
                                    <!-- <p>Get In Touch </p> -->
                                    <form id="pop-form" action="PGDM-Visit12.php" method="POST" novalidate
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <input type="hidden" name="page_name" value="PGDM12">
