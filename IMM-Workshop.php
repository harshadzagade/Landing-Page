...
<head>
    ...
    <title>
        MET Institute of Mass Media | Workshop on The Attention Economy: Business Behind Your Screen Time
    </title>
    <meta name="Description"
        content="Discover the business behind your screen. Learn how brands, creators, and platforms like Instagram and YouTube capture attention, influence behaviour, and generate revenue in the digital age.">
...
<body>
    ...
    <?php include 'assets/component/header_workshop.php' ?>
    ...
    <main>
        ...
        <section class="main-banner">
            <div class="custom-container-2">
                <div class="row g-4 justify-content-center align-items-center">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 pt-5">
                        <div class="banner-txt">
                            <div class="visualtxt">
                                <div class="headline-pgdm">
                                    <div class="head-line"></div>
                                </div>
                                <h1 class="linetext b-clr" style="font-size: 2.2rem; line-height: 2.8rem;">
                                    Workshop on<br>
                                    <span class="text-danger" style="font-weight: bold; font-size: 1.8rem;">The Attention Economy: Business Behind Your Screen</span>
                                </h1>
                                <p class="mt-3 text-secondary" style="font-size: 0.95rem; line-height: 1.6rem; text-align: justify;">
                                    Discover the business behind your screen. Learn how brands, creators, and platforms like Instagram and YouTube capture attention, influence behaviour, and generate revenue in the digital age. Gain industry insights and explore emerging careers shaping the future of media, marketing, and digital business. Join MET Institute of Mass Media for an insightful workshop that uncovers the business, psychology, and strategy behind the Attention Economy.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="text-center">
                            <img src="assets/images/bannerstudent.webp" class="img-fluid" alt="MET IMM Student" style="max-height: 450px; object-fit: contain;">
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-12 col-sm-12 col-12" style="z-index:1;">
                        <div class="banform" id="banform">
                            <div class="form-content">
                                <p class="fw-bold form-highlighter" style="font-size: 1.25rem;">Register Now</p>
                                <div class="form-body">
                                    <form id="pop-form" action="IMM-Workshop-Visit.php" method="POST" novalidate
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="form-group col-md-12">
                                                <div class="input-group">
                                                    <label class="inputial">Educational Qualification </label>
                                            ...
                                            <div class="form-group col-md-12">
                                                <div class="input-group">
                                                    <label class="inputial">College/Institute Name </label>
                                                    <input type="text" class="form-control rounded-pill" name="college_name"
                                            ...
                                            <!-- Hidden fields -->
                                            <input type="hidden" name="page_name" value="IMM-Workshop">
                                            <input type="hidden" name="Course" value="Attention Economy Workshop">
        ...
        <?php include 'assets/component/content_workshop.php' ?>
