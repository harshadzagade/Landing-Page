...
$programme_name = "PGP in Data Science and Machine Learning";
$extraegde_id = "13";
$institute_name = "Institute of Software Development and Research";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Utm content - entry.1016448109
// utm_keyword - entry.1849714904
// utm_adposition - entry.731416879
// utm_placement - entry.2106740829
// utm_matchtype - entry.552182812
// utm_creative - entry.743346065
...
$sql = "INSERT INTO landing_page (name, email, mobile, city, qualification, programme_name, extraegde_id, institute_name, page_name, utm_source, utm_medium, utm_campaign, utm_adgroup, utm_device, utm_term, utm_content, utm_keyword, utm_adposition,  utm_placement, utm_matchtype, utm_creative, gclid, fbclid, url) VALUES ('$fname', '$email', '$mobile', '$city', '$qualification', '$programme_name', '$extraegde_id', '$institute_name', '$page_name', '$utm_source', '$utm_medium', '$utm_campaign', '$utm_adgroup', '$utm_device', '$utm_term', '$utm_content', '$utm_keyword', '$utm_adposition', '$utm_placement', '$utm_matchtype', '$utm_creative', '$gclid', '$fbclid', '$url')";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        $urls = [
            'https://docs.google.com/forms/d/e/1FAIpQLSfJTJBdhcYwG1kSCewCLbbjRHSPavWrFPjkM1leFvOsdW19cQ/formResponse',
        ...
        $postData = [
            [
                ...
                'entry.163805895' => $utm_content,
                'entry.1876711730' => $utm_keyword,
                'entry.1130874550' => $utm_adposition,
                'entry.1811234940' => $utm_placement,
                'entry.890992613' => $utm_matchtype,
                'entry.1823109078' => $utm_creative,
        ...
        // Redirect if success
        if ($redirect) {
            header("Location: PGP-Data-Science-Machine-Learning-Res.php");
