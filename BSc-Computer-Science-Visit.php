...
$programme_name = "BSc Computer Science - UOL Goldsmiths";
$extraegde_id = "120";
$institute_name = "IIS";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Utm content - entry.580307485
// utm_keyword - entry.2118666623
// utm_adposition - entry.1367471901
// utm_placement - entry.2551233
// utm_matchtype - entry.1483509033
// utm_creative - entry.590590101
...
$sql = "INSERT INTO landing_page (name, email, mobile, city, qualification, programme_name, extraegde_id, institute_name, page_name, utm_source, utm_medium, utm_campaign, utm_adgroup, utm_device, utm_term, utm_content, utm_keyword, utm_adposition,  utm_placement, utm_matchtype, utm_creative, gclid, fbclid, url) VALUES ('$fname', '$email', '$mobile', '$city', '$qualification', '$programme_name', '$extraegde_id', '$institute_name', '$page_name', '$utm_source', '$utm_medium', '$utm_campaign', '$utm_adgroup', '$utm_device', '$utm_term', '$utm_content', '$utm_keyword', '$utm_adposition', '$utm_placement', '$utm_matchtype', '$utm_creative', '$gclid', '$fbclid', '$url')";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        $urls = [
            'https://docs.google.com/forms/d/e/1FAIpQLSfnXtd0F2ltZjoQH5g7bkfet8I8dshx_JzSMXEOIg_tziJK2w/formResponse',
        ...
        $postData = [
            [
                ...
                'entry.1741098389' => $utm_content,
                'entry.762050284' => $utm_keyword,
                'entry.838956409' => $utm_adposition,
                'entry.1785723496' => $utm_placement,
                'entry.1585511959' => $utm_matchtype,
                'entry.1427973301' => $utm_creative,
        ...
        // Redirect if success
        if ($redirect) {
            header("Location: BSc-Computer-Science-Res.php");
