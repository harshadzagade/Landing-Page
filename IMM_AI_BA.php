...
<body>
    ...
    <main>
                    ...
                    <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6 col-12 pt-5">
                        <div class="banner-txt">
                            <div class="visualtxt ">
                                ...
                                <p>
                                    Specialization in NextGen Media & AI
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <?php include 'assets/component/content_AI.php' ?>
    ...
    <script
        src="https://eeconfigstaticfiles.blob.core.windows.net/staticfiles/met/ee-form-widget/form-26/widget.js"></script>
