...
<body>
                        ...
                        <div class="banner-txt">
                            <div class="visualtxt ">
                                ...
                                <p>
                                    ...
                                    2 + 1 with an option for 3rd year Transfer to Royal Holloway, University of London,
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="banform" id="banform">
                            <div class="form-content">
                                ...
                                <div class="form-body">
                                    ...
                                    <!-- <form id="pop-form" action="BSc-Business-Administration-Visit9.php" method="POST" novalidate
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <input type="hidden" name="page_name" value="IIS UOL RH9">
    ...
    <script
        src="https://eeconfigstaticfiles.blob.core.windows.net/staticfiles/met/ee-form-widget/form-17/widget.js"></script>
