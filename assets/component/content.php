        ...
        <div class="row g-5">
            <div class="col-lg-6 col-md-12">
                <div class="about-pgdm">
                    <img src="assets/images/about/PGP_EMBA_BA.png" alt="about">
                </div>
            </div>
            <div class="col-lg-6 col-md-12 headline2-about">
                ...
                <div class="info_data">
                    <p>The ‘Post Graduate Program in Strategic Business Analytics’ (PGP in Business Analytics) is a
                        two-year, autonomous program at MET AMDC, offering 4 certificate options and specializations in
                        Marketing Analytics, Finance Analytics, and Human Resources Analytics, as well as a
                        comprehensive understanding of management analysis. This program aims to equip young
                        professionals with the necessary skills to effectively apply data analytics in their
                        decision-making processes in management. The program covers essential business management
                        concepts and their practical application in real-world businesses.
                    </p>
                </div>
        ...
        <div class="row align-items-end">
            <div class="col-lg-7 col-md-12">
                ...
                <div class="pgdm-gap1">
                    ...
                    <div class="pgdm-checksign">
                        <img class="check-sign" src="assets/images/icons/checksign.svg" alt="">
                        <p class="check-text">Centre of Excellence in collaboration with leading Corporates and Academia
                        </p>
                    </div>
                    <div class="pgdm-checksign">
                        <img class="check-sign" src="assets/images/icons/checksign.svg" alt="">
                    ...
                    <div class="pgdm-checksign">
                        <img class="check-sign" src="assets/images/icons/checksign.svg" alt="">
                        <p class="check-text">Well networked with corporates and institutions in India and abroad</p>
                    </div>
                    <!-- <div class="pgdm-checksign">
                        <img class="check-sign" src="assets/images/icons/checksign.svg" alt="">
                        <p class="check-text">State-of-the-art infrastructure</p>
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body info_data">
                                ...
                                <ul>
                                    ...
                                    <li>Beyond regular MBA syllabus for data-driven environment</li>
                                    <li>Hands-on use of Tools and Application Orientation</li>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                            ...
                            <div class="accordion-body info_data">
                                <hr />
                                <ul>
                                    <li>Graduate in any discipline from a recognised university, final-year students can
                                        also apply.</li>
                                    <li>Students in the final year/semester exam can apply</li>
                                    <li>Valid scorecard of CAT, XAT, ATMA, MH-CET, CMAT, GMAT, NMAT, MAT (any)</li>
                                    <li>Those awaiting results of the above MBA entrance exams can also apply</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="takeaways-carousel owl-carousel">
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Analytics Fundamentals</strong>
                                    <p class="takeaways-subtitle">
                                        Understanding of statistical methods, data visualization techniques, and
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Data Management</strong>
                                    <p class="takeaways-subtitle">
                                        Knowledge of data wrangling, cleaning, and preprocessing techniques to prepare
                                        data for analysis.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Business Strategy</strong>
                                    <p class="takeaways-subtitle">
                                        Ability to identify business problems and leverage data and analytics to develop
                                        strategic solutions.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Machine Learning</strong>
                                    <p class="takeaways-subtitle">
                                        Knowledge of advanced machine learning techniques such as regression, decision
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Big Data</strong>
                                    <p class="takeaways-subtitle">
                                        Understanding of big data technologies, platforms, and tools, such as Hadoop,
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Communication & Presentation</strong>
                                    <p class="takeaways-subtitle">
                                        Effective communication and presentation skills to effectively convey
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Industry Applications</strong>
                                    <p class="takeaways-subtitle">
                                        Exposure to real-world business scenarios and case studies, and an understanding
                                        of how analytics is being applied across various industries.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Team Collaboration</strong>
                                    <p class="takeaways-subtitle">
                                        Collaboration and teamwork skills to work with cross-functional teams and
                                        stakeholders on data-driven projects.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="contact-pad">
                                    ...
                                    <div class="para-title">
                                        <h5 class="para-text">MET Institute of Asian Management Development Centre</h5>
                                    </div>
                        ...
                        <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen"
                            ...
                            <div class="accordion-body info_data_2">
                                ...
                                <p>
                                    ...
                                    Analytics, and Human Resources Analytics besides a holistic view and in-depth
                                    analytical capability in the core area of Management.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="collapseEleven" class="accordion-collapse collapse" aria-labelledby="headingEleven"
                            ...
                            <div class="accordion-body info_data_2">
                                <hr />
                                <p>
                                    Business Analytics is a rapidly expanding discipline that investigates techniques
                                    of understanding data within an organization in order to strengthen decision-
                                    making. As part of our mission to create professionals, we emphasize the new data-
                                    savvy management opportunities which focus on the below-mentioned areas :
                                    ...
                                    Business Communication, Self-Awareness, and Emotionally Intelligent
                                    Communication
                    ...
                    <div class="accordion-item">
                        <p class="accordion-header" id="headingthirteen">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="d-flex justify-content-start align-items-center">
                                    <p class="mb-0">What is the Outcome of the programme?</p>
                                </div>
                            </button>
                        </p>
                        <div id="collapsethirteen" class="accordion-collapse collapse" aria-labelledby="headingthirteen"
                            ...
                            <div class="accordion-body info_data_2">
                                <hr />
                                <p>With an outcome for the development of scenario building and terrain
                                    appreciation skills to stimulate live grassroots-based contextual management
                                    expertise following result should be expected:
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <p class="accordion-header" id="headingFourteen">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="d-flex justify-content-start align-items-center">
                                    <p class="mb-0">What are the eligibility criteria?</p>
                                </div>
                            </button>
                        </p>
                        ...
                        <div id="collapseSixteen" class="accordion-collapse collapse" aria-labelledby="headingSixteen"
                            ...
                            <div class="accordion-body info_data_2">
                                ...
                                <p>Currently the Institute does not provide hostel facilities to students. However,
                                    it endeavors to help students to procure accommodation around the MET campus.</p>
                            </div>
                        </div>
                    </div>
                </div>
