        ...
        <div class="row g-5">
            <div class="col-lg-6 col-md-12">
                <div class="about-pgdm">
                    <img src="assets/images/about/Royal_Holloway.png" alt="about">
                </div>
            </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="pgdm-gap">
                            ...
                            <div class="pgdm-checksign">
                                <img class="check-sign" src="assets/images/icons/checksign.svg" alt="">
                                <p class="check-text">International Business</p>
                            </div>
                            <div class="pgdm-checksign">
                                <img class="check-sign" src="assets/images/icons/checksign.svg" alt="">
                                <p class="check-text">Marketing</p>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="contact-pad">
                                    ...
                                    <div class="para-title">
                                        <h5 class="para-text">MET Institute of International Studies</h5>
                                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen"
                            ...
                            <div class="accordion-body info_data_2">
                                <hr />
                                <p>
                                    BSc Business Administration - Awarding Body University of London & Academic
                                    Direction by
                                    Royal Holloway.
                                </p>
                            </div>
                    ...
                    <div class="accordion-item">
                        <p class="accordion-header" id="headingfiftyteen">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="d-flex justify-content-start align-items-center">
                                    <p class="mb-0">What is a BSc Business Administration Programme?
                                    </p>
                                </div>
                            </button>
                        </p>
                        <div id="collapsefiftyteen" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body info_data_2">
                                <hr />
                                <p>Prepare for today's highly competitive business environment and learn to devise
                                    effective
                                    solutions to real management situations.
                                    Study general Business Administration or specialize in one of three pathways: Human
                                    Resource Management, International Business or Marketing.
                                <ul>
                                    <li>BSc Business Administration (Academic direction by Royal Holloway)</li>
                                    <li>Business Administration- General Pathway</li>
                                    <li>Business Administration - Human Resource Management</li>
                                    <li>Business Administration - International Business</li>
