        ...
        <div class="row g-5">
            <div class="col-lg-6 col-md-12">
                <div class="about-pgdm">
                    <img src="assets/images/about/Insurence.png" alt="about">
                </div>
            </div>
            <div class="col-lg-6 col-md-12 headline2-about">
                ...
                <div class="info_data">
                    <p>MET, Mumbai, a leading B-School in Maharashtra has partnered with The Chartered Insurance
                        ...
                        It's more than a PGDM in Insurance or MBA-Insurance, the course also awards internationally
                        recognized ACII qualification and chartered status to students on completion.
                    </p>
                </div>
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body info_data">
                                ...
                                <ul>
                                    ...
                                    <li>Optional London educational tour</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                            ...
                            <div class="accordion-body info_data">
                                <hr />
                                <ul>
                                    <li>Graduate in any discipline. In the case of foreign nationals, the university
                                        must be approved by the respective state/country.</li>
                                    <li>Those who are appearing for the final year of the Degree Examination in the
                                        current year can also apply.
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="takeaways-carousel owl-carousel">
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Insurance sector knowledge</strong>
                                    <p class="takeaways-subtitle">
                                        The course provides in-depth knowledge of the insurance sector, including
                                        principles, products, and regulatory frameworks.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Business Administration</strong>
                                    <p class="takeaways-subtitle">
                                        Students learn about management and business administration concepts, such as
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Empowered leadership</strong>
                                    <p class="takeaways-subtitle">
                                        The course focuses on developing leadership skills, such as communication,
                                        decision making, and problem solving, to empower students to effectively manage
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Risk Management</strong>
                                    <p class="takeaways-subtitle">
                                        Students learn about identifying, assessing and managing risks in the insurance
                                        sector.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Data analysis and technology</strong>
                                    <p class="takeaways-subtitle">
                                        Students learn to use data analysis and technology tools to make informed
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    <strong class="takeaways-title">Case Studies and Real-world Applications</strong>
                                    <p class="takeaways-subtitle">
                                        The course includes case studies and real-world applications to provide
                        ...
                        <div class="takeaways">
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    ...
                                    <p class="takeaways-subtitle">
                                        The programme provides opportunities for students to network with industry
                                        professionals and peers, expanding their professional connections and knowledge.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div id="testimonial-carousel" class="testimonial-carousel owl-carousel">
                    <div class="testimonial-card">
                        <div class="img-testimonial d-flex align-items-center">
                            <div>
                                <img class="student-images" src="assets/images/test/Tess.jpg"
                    ...
                    <div class="testimonial-card">
                        <div class="img-testimonial d-flex align-items-center">
                            <div>
                                <img class="student-images" src="assets/images/test/Nishin.jpg"
                                    alt="testimonial carousel slider 2">
                            </div>
                            <div>
                                <h5 class="card-title">Nishin Saleem</h5>
                                <span class="text-secondary"></span>
                            </div>
                            <!-- <div class="svg-icon-testimonial">
                                <img class="svg-img" src="assets/images/icons/quotes.svg" alt="svg-icon">
                    ...
                    <div class="testimonial-card">
                        <div class="img-testimonial d-flex align-items-center">
                            <div>
                                <img class="student-images" src="assets/images/test/Tushar.jpg"
                                    alt="Tushar Shrivastava">
                            </div>
                            <div>
                                <h5 class="card-title">Tushar Shrivastava</h5>
                                <span class="text-secondary"></span>
                            </div>
                            <!-- <div class="svg-icon-testimonial">
                                <img class="svg-img" src="assets/images/icons/quotes.svg" alt="svg-icon">
                        ...
                        <div class="apply-content">
                            ...
                            <div class="info_data_2">
                                <p>Verify the OTP received on your registered email/mobile number and make a
                                    non-refundable online payment of Rs. 2000.</p>
                            </div>
                        </div>
                    ...
                    <div class="contact-background">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="maps">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3771.266500814471!2d72.8296421!3d19.0520169!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c993616df25d%3A0xc06a94ab6bbb99a5!2sMET%20Centre%20for%20Insurance%20Training%2C%20Research%20%26%20Development!5e0!3m2!1sen!2sin!4v1736850463254!5m2!1sen!2sin"
                ...
                <div class="accordion" id="accordionLocationnn">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapsethirteen" class="accordion-collapse collapse" aria-labelledby="headingthirteen"
                            ...
                            <div class="accordion-body info_data_2">
                                <hr />
                                <p>Any graduate in any specialisation from a prominent university can apply to
                                    this programme. Those who are appearing for final year exams can apply too.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseFifteen" class="accordion-collapse collapse" aria-labelledby="headingFifteen"
                            ...
                            <div class="accordion-body info_data_2">
                                <hr />
                                <p>
                                    <li>International Edge</li>
                                    <li>ACII</li>
                                    <li>Double Advantage</li>
                                    <li>Exposure to International Insurance Market</li>
                                    <li>Lucrative domestic and international Placements</li>
                                    <li>Advanced Diploma in Insurance</li>
                                    <li>Top-Class Management Education</li>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <p class="accordion-header" id="headingSixteen">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="d-flex justify-content-start align-items-center">
                                    <p class="mb-0">Does MET provide education loan provisions for students?</p>
                                </div>
                            </button>
                        </p>
                        <div id="collapseSixteen" class="accordion-collapse collapse" aria-labelledby="headingSixteen"
                            ...
                            <div class="accordion-body info_data_2">
                                <hr />
                                <p>MET has designated tie-ups with the below mentioned banks to offer
                                    Educational Loans and Financial Assistance to the students.
                                    <li>Saraswat Co-op. Bank</li>
                                    <li>Axis Bank</li>
                                    <li>GrayQuest Education Finance Pvt.Ltd</li>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="collapseseventeen" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body info_data_2">
                                <hr />
                                <p>Annual Fees are Rs 3,81,355.93 + GST as applicable. Fees are payable to MET on
                                    being selected.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseeighteen" class="accordion-collapse collapse" aria-labelledby="headingeighteen"
                            ...
                            <div class="accordion-body info_data_2">
                                <hr />
                                <p>Currently the Institute does not provide hostel facilities to students. However,
                                    it endeavours to help students to procure accommodation around the MET campus.
                                </p>
                            </div>
                        </div>
                    </div>
