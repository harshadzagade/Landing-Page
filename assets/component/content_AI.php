        ...
        <div class="row g-5">
            <div class="col-lg-6 col-md-12">
                <div class="about-pgdm">
                    <img src="assets/images/about/Mass_Media_AI.png" alt="about">
                </div>
            </div>
            <div class="col-lg-6 col-md-12 headline2-about">
                ...
                <div class="info_data">
                    <p>AI is rewriting the rules of the media industry. Will you lead the change? The future of mass
                        media belongs to those who can merge creativity with cutting-edge technology, and MET Institute
                        of Mass Media is leading that revolution. Our PGP in Mass Communication & Media Management with
                        Specialization in NextGen Media & AI is a first-of-its-kind programme designed to equip you with
                        the skills to thrive in AI-powered media environments. From mastering generative AI tools,
                        data-driven storytelling, and immersive AR/VR experiences to creating personalised,
                        impact-driven campaigns, this Specialization blends theory with unmatched hands-on industry
                        training. With access to state-of-the-art facilities, expert faculty from media and tech
                        industries, and real-world projects, you’ll graduate ready to take on high-demand roles in the
                        evolving MediaVerse, where AI is the new language.
                    </p>
                </div>
            ...
            <div class="col-12">
                <div class="accordion" id="accordionLocationn">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingETwo"
                            data-bs-parent="#accordionLocationn">
                            <div class="accordion-body">
                                <hr />
                                <div class="row">
                    ...
                    <div class="accordion-item">
                        <p class="accordion-header" id="headingFive">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="d-flex justify-content-start align-items-center">
                                    <p class="mb-0">PGP In Mass Media & Media Management (NextGen Media & AI)</p>
                                </div>
                            </button>
                        </p>
                                ...
                                <div class="row">
                                    <div class="pgdm-gap">
                                        <div class="pgdm-checksign">
                                            ...
                                            <p class="check-text">PGP in Mass Communication & Media Management (PGP
                                                MCMM) - NextGen Media & AI is an 18-month, 3-semester programme with an
                                                industry internship that blends creativity, technology, and artificial
                                                intelligence. Designed for graduates from any field, it trains you in
                                                AI-powered content creation, data-driven storytelling, AR/VR media
                                                production, and ethical media practices.<br><br>
                                                With AI expert media faculty, cutting-edge media labs, and real-world
                                                projects, you’ll gain future-ready skills for high-demand roles like AI
                                                Content Strategist, Immersive Media Producer, Data Journalist, and
                                                Personalisation Architect across media-tech companies, creative
                                                agencies, newsrooms, and production houses.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                            ...
                            <div class="accordion-body info_data">
                                <hr />
                                <ul>
                                    <li>Concurrent AI Models</li>
                                    <li>AI-Integrated Curriculum</li>
                                    <li>Media Convergence Approach</li>
                                    <li>Lectures, Classroom Discussions & Role Plays</li>
                                    <li>Live Projects & Portfolios</li>
                                    <li>360 Degree Campaigns</li>
                                    <li>Industry Interactions</li>
                                    <li>Functional Visits, Assignments, Case Studies, Presentations & Evaluations</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <p class="accordion-header" id="headingEight">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                aria-controls="collapseEight">Selection Procedure
                            </button>
                        </p>
                    ...
                    <div class="accordion-item">
                        <p class="accordion-header" id="headingNine">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                aria-controls="collapseNine">Training Pedagogy
                            </button>
                        </p>
                            ...
                            <div class="takeaways-content">
                                ...
                                <div class="takeaways-head info_data_2">
                                    ...
                                    <p class="takeaways-subtitle">
                                        The Students get hands-on learning experience in the Specialization of their
                                        choice.
                                    </p>
                                </div>
                            </div>
